...
<div class="container mt-5">
    ...
    <tr>
        ...
        <?php if ($_SESSION['role'] === 'm'): ?>
            ...
            class="btn btn-outline-warning btn-sm me-1"><i class="fas fa-edit"></i></a>
<?php endif; ?>
<button type="button" 
        class="btn btn-outline-info btn-sm me-1" 
        data-bs-toggle="modal" 
        data-bs-target="#viewActivityModal<?= htmlspecialchars($activity_row['activity_id']) ?>"><i class="fas fa-eye"></i></button>
