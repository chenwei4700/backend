    ...
    <table class="table table-bordered table-striped text-center">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                // 查詢該隊伍在各活動中的分數
                $activity_scores_sql = "
                    SELECT activities.activity_name, COALESCE(scores.score, 0) AS score
                    FROM activities
                    LEFT JOIN scores ON activities.activity_id = scores.activity_id AND scores.team_id = ?
                ";
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="view_score.php?team_id=<?= $team_id ?>" class="btn btn-info btn-sm">檢視</a>
                    </td>
